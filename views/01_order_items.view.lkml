view: order_items {
  ...
  measure: html_count {
    ...
    drill_fields: [detail*]
    html:
    <div style="background-color: #07CDFB; color: #fff; margin:0; padding:0;">
  ...
  measure: html_order_count {
    label: "html Order Count"
    type: count_distinct
    drill_fields: [detail*]
    sql: ${order_id} ;;
    html:
...
########## Financial Information ##########
  ...
  measure: html_average_sale_price {
    label: "Average html Sale Price"
    type: average
    value_format_name: usd
    sql: ${sale_price} ;;
    drill_fields: [detail*]
